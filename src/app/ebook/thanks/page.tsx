...
export default function EbookThanksPage() {
  return (
      ...
      <div className="w-full max-w-md space-y-8 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground text-lg">
            הרכישה הושלמה בהצלחה. עכשיו כל שנותר הוא להיכנס ולהוריד את הספר.
          </p>
        </div>

        <div className="rounded-xl border bg-muted/40 p-6 space-y-3 text-right">
          <p className="font-semibold text-base">כיצד מורידים את הספר?</p>
          <p className="text-muted-foreground text-sm">
            הכנס את כתובת המייל שבה השתמשת בתהליך הרכישה. נשלח לך קישור כניסה ישירות למייל — לחץ עליו ותגיע ישירות לדף ההורדה.
          </p>
        </div>
