...
export const initialMessages: Message[] = [
  {
    role: "assistant",
    id: "0",
    content: `היי! אני עוזר דיגיטלי חכם שמבוסס על הספר "המדריך להייטקיסט המתחיל". אשמח לענות על שאלות בנושאי קריירה בהייטק, טיפים למתחילים בתעשייה, או כל דבר שקשור לתוכן הספר. במה אוכל לעזור לך היום?`,
  },
];
